...
<div class="col-md-12 content-header" >
    <h1><i class="fa fa-quote-left"></i> {{' BONS DE COMMANDE'}}</h1>
</div>
                ...
                <div class="row">
                    <div class="col-md-6" style="width:1035px;margin-left:20px"><br/>
                        @if (Session::has('flash_notification.message'))
                            {!! message() !!}
                        @endif
                    <a href="{{ route('bon.index') }}" class="btn btn-info btn-sm"> <i class="fa fa-chevron-left"></i> {{'Retour'}}</a>
                    <a href="{{ url('bon/send', $invoice->uuid) }}" class="btn btn-success btn-sm pull-right" style="margin-left: 5px"> <i class="fa fa-share"></i> {{'Envoyer'}}</a>
                    <a href="{{ url('bon/pdf', $invoice->uuid) }}" target="_blank" class="btn btn-primary btn-sm pull-right" style="margin-left: 5px"> <i class="fa fa-download"></i> {{'Télecherger'}}</a>
                    <a href="{{ route('bon.edit', $invoice->uuid) }}" class="btn btn-warning btn-sm pull-right" > <i class="fa fa-pencil"></i> {{'Modifier'}}</a>
                </div>
                </div>
                        ...
                        <div class="invoice">
                            <div class="row">
                                ...
                                <div class="col-md-9 text-right">
                                    <div class="panel-body">
                                        <div class="col-xs-12 text-right"> <h1>{{'bons de commande'}}</h1></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                        <div class="panel-body">
                                            ...
                                            {{'Télephone'}}: {{ $invoice->client->phone }}<br/>
