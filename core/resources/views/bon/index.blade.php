            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title pull-right">
                        <div class="box-tools ">
                            <a href="{{ route('bon.create') }}" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> {{ 'Créer Bon' }}</a>
                        </div>
                    </h3>
                </div>
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover datatable">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! route('bon.show',$invoice->uuid) !!}" data-rel="tooltip" data-placement="top" title="View invoice" class="btn btn-sm btn-info"><i class="fa fa-eye"></i>  </a>
                                ...
                                <a href="{!! route('bon.edit',$invoice->uuid) !!}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i> {{'Modifier'}} </a>
                                {!! delete_btn('bon.destroy', $invoice->uuid) !!}
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
