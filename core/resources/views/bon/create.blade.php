...
<div class="row">
    <div class="invoice">
        {!! Form::open(['route' => ['bon.store'], 'id' => 'invoice_form', 'data-toggle'=>"validator", 'role' =>"form"]) !!}
        <div class="col-md-12">
            ...
            <div class="col-md-7" style="padding: 0px">
                <div class="contact to">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('number','bon_'.$invoice_num, ['class' => 'form-control input-sm hide', 'id' => 'number', 'required']) !!}
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
@section('scripts')
    @include('bon.partials._invoices_js')
@endsection
