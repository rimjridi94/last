...
<div class="col-md-12 content-header" >
    <h1><i class="fa fa-file-pdf-o"></i> {{' BONS DE COMMANDE' }}</h1>
</div>
            ...
            <div class="panel panel-default">
                <div class="row">
                    <div class="col-md-6" style="width:1035px;margin-left:20px"><br/>
                        <a href="{{ route('avoir.index') }}" class="btn btn-info btn-sm"> <i class="fa fa-chevron-left"></i> {{ 'Retour' }}</a>
                        <a href="{{ route('avoir.show', $invoice->uuid) }}" class="btn btn-primary btn-sm pull-right"> <i class="fa fa-search"></i>  {{'Aperçu'}}</a>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="invoice">
                            {!! Form::model($invoice, ['route' => ['bon.update', $invoice->uuid],  'method' => 'PATCH', 'id' => 'invoice_form', 'data-toggle'=>"validator", 'role' =>"form"]) !!}
                            <div class="col-md-12">
                                <div class="text-right"><h1>{{ 'bons de commande'}}</h1></div>
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-sm btn-success pull-right" id="saveInvoice"><i class="fa fa-save"></i> {{'Enregistrer de la facture'}}</button>
                            </div>
                            {!!  Form::close() !!}
                        </div>
                        </div>
