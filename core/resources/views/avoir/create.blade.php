...
<div class="col-md-12 content-header" >
    <h1><i class="fa fa-file-pdf-o"></i> {{' AFFICHER' }}</h1>
</div>
...
<div class="row">
    <div class="invoice">
        ...
        <div class="col-md-12">
          <div class="text-right"><h1>{{ ' AFFICHER' }}</h1></div>
            <div class="col-md-7" style="padding: 0px">
                <div class="contact to">
                    ...
                    <div class="form-group">
                        {!! Form::label('number', 'Numéro facture') !!}
                        <div class="input-group col-md-7">
    ...
    <div class="col-md-6">
        ...
        <span id="btn_product_list_modal" class="btn btn-sm btn-primary "><i class="fa fa-plus"></i> {{ 'Ajouer un produit' }}</span>
    </div><!-- /.col -->
    <div class="col-md-6">
        <table class="table">
            <tbody>
    ...
    <div class="col-md-12">
        <button type="submit" class="btn btn-sm btn-success pull-right" id="saveInvoice"><i class="fa fa-save"></i> {{ 'Enregistrer la facture' }}</button>
    </div>
    {!!  Form::close() !!}
    </div>
    </div>
