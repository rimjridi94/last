                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover datatable">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! route('avoir.show',$invoice->uuid) !!}" data-rel="tooltip" data-placement="top" title="View invoice" class="btn btn-sm btn-info"><i class="fa fa-eye"></i>  </a>
                                ...
                                <a href="{!! route('avoir.edit',$invoice->uuid) !!}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i> {{trans('application.edit')}} </a>
                                {!! delete_btn('avoir.destroy', $invoice->uuid) !!}
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
