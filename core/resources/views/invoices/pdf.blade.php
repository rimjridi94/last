<div class="container">
        ...
        <div class="text-right" style="width:300px;height:150px;float:right;">
            <div style="color: #cb9b42" class="text-right"> <h2>{{trans('application.invoice')}}</h2></div>
    ...
    <div class="col-md-12">
        <table class="table">
            ...
            <tr style="background-color:#ccae62!important;">
                ...
                <th style="width:15%" class="text-right">{{trans('application.nb_jours')}}</th>
       ...
       <div class="col-md-6" style="padding: 7% 25% 0 10%;width: 30%; text-transform: uppercase">
           <div >
             ...
             <table class="table">
                 ...
                 <tr>
                     <th class="text-right">droit. timbre</th>
                     <td class="text-right">
                 ...
                 <tr class="amount_due "  >
                     ...
                     <td class="text-right">
                         <span id="grandTotal">{{ $invoice->currency.' '.($invoice->totals['net']) }}</span>
                     </td>

                 </tr>
                 </tbody>
             </table>
       <h4 class="invoice_title text-right" style="margin-top: 30%;margin-right:20%;color: black">Signature</h4>
     </div><!-- /.col -->
